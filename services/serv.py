...
def get_distance(symbol: str = 'BTC', left_to_exp: float = 10.0, which_pos_we_need: str = 'second'):
    ...
    if symbol in ['ETH', 'SOL']:
        ...
        distance = 0.005 if left_to_exp < 10 else 0.006 if left_to_exp < 15 or which_pos_we_need == 'second' else  0.007
    return distance
...
def auto_set_expect(h):
    ...
    Commands.set_expect_1(exp-2, 'BTC')
    sv.stages['first']['expect'] = exp-2
