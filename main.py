...
async def main():
    ...
    while True:
        try:
            ...
            if ((h in [11, 12, 13, 14] and weekday in [0,1,2,3,4]) and which_pos_we_need == 'first') or second_hedge or (sv.force_take and which_pos_we_need != 'nothing'):
                ...
                if best_simulation:
                    ...
                    if (best_simulation['pnl'] >= expect and best_simulation['strike_perc']<= distance) or sv.force_take:
                        Commands.set_force_take(False)
